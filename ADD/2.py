...
"}")
        ...
        self.frame.setGeometry(QtCore.QRect(0, 0, 300, 1080))
...
"}")
        ...
        self.pushButton_2_2.setGeometry(QtCore.QRect(80, 750, 110, 100))
...
"}")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("images/icon/notes.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_2_2.setIcon(icon)
        self.pushButton_2_2.setIconSize(QtCore.QSize(80, 80))
        self.pushButton_2_2.setObjectName("pushButton_2_2")
        self.label_2_1 = QtWidgets.QLabel(self.frame)
        self.label_2_1.setGeometry(QtCore.QRect(20, 230, 241, 31))
        font = QtGui.QFont()
...
"}")
        ...
        self.label_2_16.setGeometry(QtCore.QRect(80, 870, 171, 20))
        font = QtGui.QFont()
        font.setPointSize(20)
...
"}")
        ...
        self.pushButton_2_1.setGeometry(QtCore.QRect(90, 120, 110, 100))
...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("images/icon/clock-1 - Copy.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_2_1.setIcon(icon1)
        self.pushButton_2_1.setIconSize(QtCore.QSize(80, 80))
        self.pushButton_2_1.setObjectName("pushButton_2_1")
        self.label_2_1.raise_()
        self.pushButton_2_1.raise_()
        self.pushButton_2_2.raise_()
        self.label_2_16.raise_()
        self.frame_2 = QtWidgets.QFrame(GUI_2)
        self.frame_2.setGeometry(QtCore.QRect(1620, 0, 300, 1080))
        self.frame_2.setSizeIncrement(QtCore.QSize(17, 0))
...
"}")
        ...
        self.pushButton_2_5.setGeometry(QtCore.QRect(100, 120, 110, 100))
        self.pushButton_2_5.setMaximumSize(QtCore.QSize(16777215, 16777215))
...
"}")
        ...
        self.pushButton_2_5.setIconSize(QtCore.QSize(80, 80))
        self.pushButton_2_5.setObjectName("pushButton_2_5")
        self.groupBox_2 = QtWidgets.QGroupBox(self.frame_2)
        self.groupBox_2.setGeometry(QtCore.QRect(30, 700, 250, 130))
        font = QtGui.QFont()
...
"}")
        ...
        self.label_2_5.setGeometry(QtCore.QRect(20, 60, 51, 21))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(20)
...
"}")
        ...
        self.label_2_6.setGeometry(QtCore.QRect(190, 60, 51, 21))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(20)
...
"}")
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(30, 320, 250, 190))
        font = QtGui.QFont()
        font.setFamily("Tw Cen MT")
        font.setPointSize(20)
...
"}")
        ...
        self.label_2_9.setGeometry(QtCore.QRect(20, 50, 41, 16))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(20)
...
"}")
        ...
        self.label_2_8.setGeometry(QtCore.QRect(20, 100, 51, 16))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(20)
...
"}")
        ...
        self.label_2_7.setGeometry(QtCore.QRect(20, 150, 61, 16))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(20)
...
"}")
        ...
        self.groupBox_4.setGeometry(QtCore.QRect(30, 540, 250, 130))
        font = QtGui.QFont()
        font.setFamily("Tw Cen MT")
        font.setPointSize(20)
...
"}")
        ...
        self.label_2_10.setGeometry(QtCore.QRect(20, 60, 51, 21))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(20)
...
"}")
        ...
        self.label_2_11.setGeometry(QtCore.QRect(190, 60, 51, 20))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(20)
...
"}")
        ...
        self.groupBox.setGeometry(QtCore.QRect(30, 850, 250, 130))
        font = QtGui.QFont()
        font.setFamily("Tw Cen MT")
        font.setPointSize(20)
...
"}")
        ...
        self.label_2_12.setGeometry(QtCore.QRect(20, 60, 51, 21))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(20)
...
"}")
        ...
        self.label_2_13.setGeometry(QtCore.QRect(190, 60, 51, 21))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(20)
...
"}")
        ...
        self.label_2_2.setGeometry(QtCore.QRect(100, 230, 121, 31))
        font = QtGui.QFont()
...
"}")
        ...
        self.label_2_14.setGeometry(QtCore.QRect(240, 30, 300, 50))
        font = QtGui.QFont()
        font.setPointSize(7)
...
"}")
        ...
        self.comboBox_2_1.setGeometry(QtCore.QRect(750, 50, 521, 31))
...
"}")
        ...
        self.label_2_3.setGeometry(QtCore.QRect(960, 10, 111, 31))
        font = QtGui.QFont()
        ...
        self.horizontalSlider_2_1.setGeometry(QtCore.QRect(340, 880, 380, 80))
...
"}")
        ...
        self.horizontalSlider_2_2.setGeometry(QtCore.QRect(1150, 880, 380, 80))
        self.horizontalSlider_2_2.setMinimum(240)
        self.horizontalSlider_2_2.setMaximum(480)
        ...
        self.verticalSlider_2_1.setGeometry(QtCore.QRect(1530, 440, 80, 380))
        ...
        self.label_2_4.setGeometry(QtCore.QRect(760, -30, 1461, 1081))
        font = QtGui.QFont()
        ...
        self.label_2_19.setGeometry(QtCore.QRect(450, 810, 111, 31))
        font = QtGui.QFont()
        font.setPointSize(18)
...
"}")
        ...
        self.label_2_20.setGeometry(QtCore.QRect(1280, 810, 121, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
...
"}")
        ...
        self.label_2_21.setGeometry(QtCore.QRect(1430, 610, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
...
"}")
        ...
        self.label_2_15.setGeometry(QtCore.QRect(1380, 30, 300, 50))
...
"}")
        ...
        self.radioButton_2_2.setGeometry(QtCore.QRect(1450, 40, 171, 31))
        font = QtGui.QFont()
        font.setPointSize(24)
        font.setBold(True)
        font.setWeight(75)
...
"}")
        ...
        self.radioButton_2_1.setGeometry(QtCore.QRect(290, 40, 191, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
...
"}")
    ...
    def retranslateUi(self, GUI_2):
        ...
        self.label_2_21.setText(_translate("GUI_2", "Posis y"))
